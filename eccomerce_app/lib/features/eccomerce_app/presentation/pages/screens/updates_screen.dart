...
class _UpdatesScreenState extends State<UpdatesScreen> {
  ...
  void initState() {
    ...
    sizeController = TextEditingController(text: widget.product.sizes.join(', '));
  }
  ...
  // delete product
void _deleteProduct() {
  // Get the bloc before showing dialog to ensure context is available
  ...
  showDialog(
    ...
    builder: (BuildContext context) => AlertDialog(
      ...
      actions: <Widget>[
        ...
        TextButton(
          onPressed: () {
            // Dispatch the event using the previously obtained bloc
            productBloc.add(DeleteProductEvent(widget.product.id.toString()));
    ...
    return BlocListener<ProductBloc, ProductState>(
      listener: (context, state) {
        if (state is ErrorState) {
          ...
          // Product was successfully updated, navigate back
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: _imageFile != null
                              ...
                              : widget.product.imagePath.isNotEmpty
                                  ? DecorationImage(
                                      image: widget.product.imagePath.startsWith('assets/')
                                          ? AssetImage(widget.product.imagePath)
                                          : FileImage(File(widget.product.imagePath)),
                                      fit: BoxFit.cover,
                                    )
                                  : null,
                        ),
                        child: _imageFile == null && widget.product.imagePath.isEmpty
                            ? const Column(
